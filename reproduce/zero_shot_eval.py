...
def evaluate_once_accuracy(
    ...
    return retrieval_hit_by_k, retrieval_r_by_k, supervised_acc, len(q_items), len(r_items)
...
def main() -> None:
    ...
    if use_paper_folds:
        ...
        retrieval_hit_by_k, retrieval_r_by_k, supervised_acc, nq, nr = evaluate_once_accuracy(
            model,
            q_type,
            r_type,
            all_items,
